...
const ShopBySpecificBike = () => {
  ...
  const bikes = [
    { 
      name: 'Aprilia RS 457', 
      image: 'https://res.cloudinary.com/dbplgk8d8/image/upload/v1778609968/Aprilla_sgqr0p.jpg' 
    },
    { 
      name: 'Apache RTX 300', 
      image: 'https://res.cloudinary.com/dbplgk8d8/image/upload/v1778610065/tvs-rtsx-0-1770097813_n7ikeo.avif' 
    },
    { 
      name: 'Himalayan 450', 
      image: 'https://res.cloudinary.com/dbplgk8d8/image/upload/v1778609855/2_ybj2rd.avif' 
    },
    { 
      name: 'Kawasaki Z900', 
      image: 'https://res.cloudinary.com/dbplgk8d8/image/upload/v1778610216/6929e135-b127-4b2b-ba6c-6428e9942784_prqssd.png' 
    },
    { 
      name: 'Yamaha XSR 155', 
      image: 'https://res.cloudinary.com/dbplgk8d8/image/upload/v1778610218/xsr_black_lulcuy.webp' 
    },
    { 
      name: 'Yezdi Adventure 2025', 
      image: 'https://res.cloudinary.com/dbplgk8d8/image/upload/v1778610217/ltp0cgb_1838720_trnc2c.avif' 
    },
  ];
    ...
    <section className="py-8 sm:py-12 md:py-16 lg:py-20 bg-white">
      <div className="max-w-[1600px] mx-auto px-2 sm:px-4 md:px-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-6 sm:mb-8 md:mb-12 gap-3 sm:gap-4">
          <div>
            <span className="text-[#e63946] font-mono-bold text-[10px] sm:text-xs md:text-sm tracking-widest uppercase mb-1 sm:mb-2 block">Find Your Ride</span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bebas text-gray-900">SHOP BY <span className="text-[#e63946]">BIKE MODEL</span></h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 sm:gap-3 md:gap-4 lg:gap-6">
          {bikes.map((bike, idx) => (
            <motion.div
              ...
              onClick={() => handleBikeClick(bike.name)}
            ...
            >
              <div className="block w-full h-full">
                ...
                <div className="absolute bottom-0 left-0 w-full p-2 sm:p-4 md:p-6 lg:p-8 z-20 flex flex-col justify-end items-center sm:items-start text-center sm:text-left">
                  <h3 className="text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bebas text-white mb-0.5 sm:mb-1 md:mb-2 italic transform group-hover:-translate-y-1 sm:group-hover:-translate-y-2 transition-transform duration-300 leading-tight">{bike.name}</h3>
